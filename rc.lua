...
globalkeys = mytable.join(
    ...
    -- My application
    awful.key({ modkey }, "a", function () awful.spawn("vivaldi-stable") end,
              {description = "run browser", group = "launcher"}),
    awful.key({ modkey, }, "z", function () awful.spawn.with_shell("thunar") end,
              {description = "thunar", group = "launcher"}),
    awful.key({ modkey, }, "e", function () awful.spawn.with_shell("alacritty -e mocp") end,
    ...
    awful.key({ modkey, }, "q", function () awful.spawn.with_shell("alacritty -e cava -p ~/.config/cava/config") end,
