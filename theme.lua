...
theme.fg_normal                                 = "#b373b3"
theme.fg_focus                                  = "#e0da37"
theme.bg_normal                                 = "#402f5f"
theme.bg_focus                                  = "#FF402f5f"
theme.fg_urgent                                 = "#e0da37"
theme.bg_urgent                                 = "#b373b3"
theme.border_width                              = dpi(3)
theme.border_normal                             = "#402f5f"
theme.border_focus                              = "#953d70"
theme.taglist_fg_focus                          = "#e0da37"
theme.taglist_bg_focus                          = "#FF402f5f"
...
function theme.at_screen_connect(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, height = dpi(18), bg = theme.bg_normal .. "90", fg = theme.fg_normal })
    
    -- My Lauchers icon on Wibox
    
    outlet = awful.widget.launcher({ image = "/home/akze/.config/awesome/themes/rainbow/icons/App/outlet.png",
                                     command = "app-outlet" })
    
    molotov = awful.widget.launcher({ image = "/home/akze/.config/awesome/themes/rainbow/icons/App/molotov.png",
                                     command = "/home/akze/Applications/./molotov_5b199c8affc65fb40ec566cdba11df97.AppImage" })
    
    writer = awful.widget.launcher({ image = "/home/akze/.config/awesome/themes/rainbow/icons/App/writer.png",
                                     command = "soffice --writer" })
    
    discover = awful.widget.launcher({ image = "/home/akze/.config/awesome/themes/rainbow/icons/App/discover.png",
...
mymainmenu = awful.menu({ items = { { 'awesome', myawesomemenu, theme.awesome_icon },
                                    { "Konsole", "konsole", "/home/akze/.config/awesome/themes/rainbow/icons/App/terminal.svg" },
                                    { "Firefox", "firefox", "/home/akze/.config/awesome/themes/rainbow/icons/App/firefox.svg" },
                                    { "Thunar", "thunar", "/home/akze/.config/awesome/themes/rainbow/icons/App/thunar.svg" }
                                  }
                        })
