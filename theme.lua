...
theme.wallpaper                                 = theme.dir .. "/wall9.png"
...
theme.taglist_bg_focus                          = "#41414D" --gris 
theme.taglist_fg_empty                        	= "#6f7ca0" --bleu clair
theme.taglist_bg_empty                         	= "#31313a" --gris sombre
theme.menu_height                               = dpi(16)
theme.tasklist_fg_focus							= "#e0da37" --jaune
theme.tasklist_fg_normal						= "#6f7ca0" --bleu clair
theme.tasklist_bg_focus							= "#41414D" --gris 
theme.tasklist_bg_normal						= "#41414D" --gris 
...
s.mytasklist = awful.widget.tasklist {
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, height = dpi(20), bg = theme.bg_focus, fg = theme.fg_focus })
    ...
    molotov = awful.widget.launcher({ image = "/home/akze/.config/awesome/themes/rainbow-dark/icons/App/molotov.png",
                                     command = "/home/akze/Applications/./molotov.AppImage" })
    ...
    screenshot = awful.widget.launcher({ image = "/home/akze/.config/awesome/themes/rainbow-dark/icons/App/screenshot.png",
...
mymainmenu = awful.menu({ items = { { 'awesome', myawesomemenu, theme.awesome_icon },
                                    ...
                                    { "vivaldi-stable", "vivaldi-stable", "/home/akze/.config/awesome/themes/rainbow-dark/icons/App/vivaldi.svg" },
